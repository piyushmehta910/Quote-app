...
val SecondaryVariant = Color(0xFFE5506D)
val Tertiary = Color(0xFF00C9A7)
...
val OutlineLight = Color(0xFFE2E5EA)
val SurfaceVariantLight = Color(0xFFF1F3F7)
...
val OutlineDark = Color(0xFF2E3038)
val SurfaceVariantDark = Color(0xFF22242C)
